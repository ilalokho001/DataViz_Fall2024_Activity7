                                 ...
                                 margin = 50)
{
    ...
    function brushStart() {
        ...
        if (d3.brushSelection(this)[0][0] === d3.brushSelection(this)[1][0]) {
            d3.selectAll(".selected").classed("selected", false); //remove selected circles
            d3.select("#selected-list").selectAll("li").remove(); // remove the selected cars from the html
        }
    }
    ...
    legends_items.append("rect")
        ...
        .on("click", function (_, d) {
            ...
            // Adjust the opacity of the corresponding points
            d3.selectAll(`.${d}`)
                .transition()
                .duration(300)
